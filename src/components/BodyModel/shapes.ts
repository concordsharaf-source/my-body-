...
const CIRCULATORY: ShapeDef[] = [
  ...
  S({
    ...
    sw: 1.4,
    d: 'M 185.5,191 C 176.7,189 168,193 163,200 C 159,210 160,221 165.5,231 C 170,238 179,243 186,243 C 193,242 197.5,235 199,227 C 201.5,218 200.5,205 196,197 C 193,192 189,191 185.5,191 Z',
  }),
  ...
  S({
    ...
    grad: 'g-circulatory',
    op: 0.85,
    d: 'M 166,208 C 164,201 168,195 174,193 C 180,191 186,191 191,194 C 196,196 198,201 197,207 C 192,211 185,212 178,211 C 173.5,211 169.5,210 166,208 Z',
  }),
  ...
  S({
    ...
    op: 0.8,
    d: 'M 161.5,213 C 170,219 186,219 198,211 M 181.5,215 C 183,224 185.5,234 188,241 M 172,220 C 176,227 182,233 189.5,237 M 165.5,216 C 168,223 172,230 177,235',
  }),
  // قوس الأبهر
  S({
    id: 'cir-aortic-arch',
    ...
    organId: 'aorta',
    tone: 'art',
    d: 'M 176,192 C 173,182 176,172 183,168 C 190,164 196,168 196,176 C 196,184 193,190 190,196',
  }),
  // جذع الشريان الرئوي
  S({
    id: 'cir-pulm-trunk',
    ...
    tone: 'ven',
    d: 'M 182,192 C 182,186 184,180 188,176',
  }),
]
...
const VESSELS: ShapeDef[] = [
  ...
  S({
    ...
    organId: 'aorta',
    tone: 'art',
    d: 'M 190,196 C 189,208 188,230 187,255 C 186,282 185,310 184,335 C 183.5,342 183,347 183,351 M 183,351 C 179,365 174,377 170,391 C 166,405 164,425 163,445 C 162.5,452 162,458 162,462 M 183,351 C 187,365 192,377 196,391 C 200,405 202,425 203,445 C 203,452 202,458 201,462',
  }),
  ...
  S({
    ...
    organId: 'venacava',
    tone: 'ven',
    d: 'M 160,150 C 159,166 160,182 164,197',
  }),
  ...
  S({
    ...
    organId: 'venacava',
    tone: 'ven',
    d: 'M 168,350 C 168,322 167,294 166,266 C 165,240 164,222 164,206',
  }),
  // الأوردة الحرقفية
  S({
    id: 'vas-iliac-v',
