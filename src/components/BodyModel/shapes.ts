...
const RESPIRATORY: ShapeDef[] = [
  S({
    ...
    kind: 'p a t h',
    organId: 'nasalcavity',
    fillVar: '--nasal-cavity',
    op: 0.5,
    d: 'M 176.5,80 C 176.5,77.5 178,76 180,76 C 182,76 183.5,77.5 183.5,80 C 183.5,84 182,87 180,87 C 178,87 176.5,84 176.5,80 Z',
  }),
  S({
    id: 'res-pharynx',
    kind: 'p a t h',
    organId: 'pharynx',
    grad: 'g-respiratory',
    d: 'M 176.5,124 Q 180,121.5 183.5,124 L 184,137 Q 180,140 176,137 Z',
  }),
  S({
    id: 'res-larynx',
    kind: 'p a t h',
  ...
  S({
    ...
    organId: 'lungs',
    mirror: true,
    d: 'M 146,246 C 152,254 160,260 168,262',
  }),
  S({
    id: 'res-alveoli',
    kind: 'p a t h',
...
const DIGESTIVE: ShapeDef[] = [
  ...
  S({
    ...
    fillVar: '--detail',
    organId: 'liver',
    d: 'M 177,283 C 175,296 175,308 178,319',
  }),
  S({
    ...
    fillVar: '--detail',
    organId: 'stomach',
    d: 'M 160,300 C 167,304 173,310 176,318 M 154,312 C 160,318 166,324 168,331 M 168,292 C 176,296 182,302 185,310',
  }),
  S({
    id: 'dig-gallbladder',
    kind: 'p a t h',
  ...
  S({
    ...
    fillVar: '--digestive-b',
    sw: 6.5,
    d: 'M 158,354 C 164,349 172,349 178,354 C 184,359 192,359 198,354 C 201,351 203,351 204,354 M 204,361 C 198,366 190,366 184,361 C 178,356 170,356 164,361 C 161,363 158,363 157,361 M 157,368 C 163,373 171,373 177,368 C 183,363 191,363 197,368 C 200,370 203,370 204,368 M 204,375 C 198,380 190,380 184,375 C 178,370 170,370 164,375 C 161,377 158,377 157,375 M 157,382 C 163,387 171,387 177,382 C 183,377 191,377 197,382 C 200,384 203,384 204,382 M 204,389 C 198,394 190,394 184,389 C 178,384 170,384 164,389 C 161,391 158,391 157,389',
  }),
  S({
  ...
  S({
    ...
    sw: 1.4,
    fillVar: '--mouth-line',
    d: 'M 173,104 C 177,105.5 183,105.5 187,104',
  }),
  S({
    id: 'dig-teeth',
    kind: 'p a t h',
    ...
    fillVar: '--tooth',
    op: 0.55,
    d: 'M 174.5,106 L 185.5,106 Q 186,107.2 185.5,108 L 174.5,108 Q 174,107.2 174.5,106 Z',
  }),
  S({
    id: 'dig-tongue',
    kind: 'p a t h',
    ...
    fillVar: '--tongue',
    op: 0.5,
    d: 'M 176,108 C 177.5,107.3 182.5,107.3 184,108 C 183,110 177,110 176,108 Z',
  }),
  S({
    id: 'dig-salivary-l',
    kind: 'circle',
...
const CIRCULATORY: ShapeDef[] = [
  S({
    ...
    organId: 'heart',
    grad: 'g-circulatory',
    d: 'M 171,237 C 161,231 149,237 146,250 C 143,263 148,279 158,290 C 167,299 179,303 189,299 C 198,295 204,286 206,275 C 208,263 206,249 198,241 C 191,234 179,231 171,237 Z',
  }),
  S({
    id: 'cir-aortic-arch',
    kind: 'p a t h',
    ...
    tone: 'art',
    organId: 'aorta',
    d: 'M 182,239 C 181,224 184,212 191,207 C 198,202 206,206 205,215 C 204,222 202,229 201,235',
  }),
  S({
    id: 'cir-svc',
    kind: 'p a t h',
    ...
    tone: 'ven',
    organId: 'heart',
    d: 'M 171,240 C 170,230 170,221 171,212 C 171.5,207 173,203 176,200',
  }),
  S({
    id: 'cir-septum',
    kind: 'p a t h',
    ...
    fillVar: '--detail',
    organId: 'heart',
    d: 'M 177,244 C 181,261 188,277 197,290',
  }),
]
...
const URINARY: ShapeDef[] = [
  S({
    ...
    mirror: true,
    grad: 'g-urinary',
    d: 'M 151,303 C 142,302 135,310 134,320 C 133,331 138,340 147,341 C 152,341 155,338 155,334 C 155,330 152,327 150,324 C 148,321 148,317 150,314 C 152,310 153,305 151,303 Z',
  }),
  S({
    id: 'uri-ureter-l',
    kind: 'p a t h',
